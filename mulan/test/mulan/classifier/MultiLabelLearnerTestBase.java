...
public abstract class MultiLabelLearnerTestBase {
	...
	static {
		...
		DATA_SET.addAttribute(Attribute.createNominalAttribute("feature_3", new String[] { "n1",
				"n2", "n3", "n4" }));
	...
	public void testBuild_WithMissingValues() throws Exception {
		...
		definition.addAttribute(Attribute.createNominalAttribute("feature_3", new String[] { "n1",
				"n2", "n3", "n4" }));
	 ...
	 * are defined as '@attribute attribute_name {1,0}' instead of '@attribute
	 * attribute_name {0,1}'
	 * 
	 * @throws Exception
	 */
