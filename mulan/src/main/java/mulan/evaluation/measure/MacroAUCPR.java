...
/**
 * Implementation of the macro-averaged AUCPR.
 *
 * @author Bin Liu
 * @version 2018.12.12
 */
...
public class MacroAUCPR extends LabelBasedAUC implements MacroAverageMeasure{
    ...
    public double getValue(int labelIndex) {
        ...
        try{
        	...
        	double d=ThresholdCurve.getPRCArea(result);
        	if(Double.isNaN(d)){
        		return 0;  //when the AUCPR is NaN (true labels only contain "1" or "0" values)
        	}
        	else{
        		return d;
        	}
