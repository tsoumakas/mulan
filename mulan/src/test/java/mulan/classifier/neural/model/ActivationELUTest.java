...
public class ActivationELUTest {
	...
	private static final double EXPECTED_FUNCT_MIN = -0.001;
	private static final double[] INPUT_VALUES = {Double.NEGATIVE_INFINITY, -2.99, -1.99, -0.1, 
												 0, 10.99,  Double.POSITIVE_INFINITY};
	/* These tests are valid only for the default slope which is equal to 0.001 */
	private static final double[] EXPECTED_FUNCT_OUT_VALUES = {-0.001, -0.000949, -0.000863, 
			-0.000095, 0, 10.99,  Double.POSITIVE_INFINITY};
	private static final double[] EXPECTED_FUNCT_DERIVATIVE_VALUES = {0, 0.000050,  0.000136, 
			0.000904};
	
	private ActivationELU function;
	
	@Before
	public void setUp(){
		function = new ActivationELU();
	}
