...
public class ActivationPreLU extends ActivationFunction {
	...
	/** Default value is set to 0.999 for numerical stability
	...
	public double derivative(double input) {
		if (input >= 0)
			throw new UnsupportedOperationException("Can't compute a derivative of the PreLU activation function.");
		else
			return slope;
	}
